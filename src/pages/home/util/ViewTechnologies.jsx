...
const ViewTechnologies = () => {
    ...
    return (
        <div className='slide-technologies'>
            <img className='background' src={backtech} alt="background" />
            <div className='title-technologies'>
                <h1>TECNOLOGIAS</h1>
            </div>
            <div className='wrapper-technologies'>
                <ContainterTechnologies title='FRONTEND' constraintsRef={constraintsRef1}>
                    <motion.div
                        className='bubble'
                        drag
                ...
                <ContainterTechnologies title='BACKEND' constraintsRef={constraintsRef2}>
                    <motion.div
                        className='bubble'
                        drag
